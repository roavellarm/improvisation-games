...
export const textEn = [
  ...
  {
    text:
      "This website is designed for cello teachers of beginning instrumental development students who use collective teaching approaches. It is the product of a master's research carried out in 2017 and 2018 at the University of São Paulo, São Paulo, Brazil.",
    style: ['paragraph'],
  },
  {
    text:
