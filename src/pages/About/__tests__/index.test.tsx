...
describe('Section Knowledge content', () => {
  it('should render correctly', () => {
    ...
    expect(
      queryByText(
        'Este site foi pensado para professores de violoncelo de estudantes iniciantes de desenvolvimento instrumental, que utilizam abordagens de ensino coletivo. É um produto de uma pesquisa de mestrado que se realizou na Universidade de São Paulo, São Paulo, Brasil, nos anos de 2017 e 2018.'
      )
    ).toBeInTheDocument()
    expect(
      queryByText(
