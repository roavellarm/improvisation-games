...
const quarantineGamesTextData: Array<ArticleItem> = [
  ...
  {
    text: 'Esse jogo é uma continuação do jogo 5. O estudante que recebeu a história gravada por seu colega deve construir, da sua maneira, uma “partitura” ou representação gráfica, na qual conste a sua forma de registrar a história sonora recebida.',
    style: ['paragraph'],
  },
  {
    text: '',
