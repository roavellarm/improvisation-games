...
const textData: Array<ArticleItem> = [
  ...
  {
    text: 'Propiciar aos estudantes a consciência da sua individualidade e seu papel dentro do coletivo, estabelecer as ideias de narrativa musical, de perguntas e respostas, enfatizando o uso das quatro cordas do violoncelo, do pizzicato, de diferentes ritmos, métricas, timbres e dinâmicas.',
    style: ['paragraph'],
  },
  {
  ...
  {
    text: 'Trabalhar as diferenças entre som e silêncio, bem como sua importância e papel dentro da construção musical; aprofundar a importância da coletividade dentro do processo musical; estabelecer a ideia de diálogo musical.',
    style: ['paragraph'],
  },
  {
    text: 'Metodologia e aplicação:',
  ...
  {
    text: 'Estabelecer uma relação entre o imaginado e o sonoro; reforçar a confiança entre pares; desenvolver o poder de escolha dentro da criação musical.',
    style: ['paragraph'],
  },
  {
    text: 'Metodologia e aplicação:',
  ...
  {
    text: 'Possibilitar a experiência de criação a partir de células musicais pré-estabelecidas; proporcionar diferenças entre as polifonias e homofonias; incentivar o poder de escolha dentro da criação musical.',
    style: ['paragraph'],
  },
  {
    text: 'Metodologia e aplicação:',
  ...
  {
    text: 'Devemos estimular os estudantes a trabalharem sua escuta e sua escolha artística frente ao material apresentado pelos colegas. Dessa forma, evitamos novamente que o jogo se torne mecânico e proporcionamos a construção de uma ideia musical consistente.',
    style: ['paragraph'],
  },
  {
    text: 'É interessante, em todos os jogos, que o professor seja o maestro na primeira vez que o jogo está sendo executado, mas que em seguida sejam escolhidos diferentes estudantes para assumirem essa função, possibilitando que todos os estudantes do grupo possam, em algum momento, participar como maestros de algum dos jogos de improvisação.',
    style: ['paragraph'],
  },
  {
  ...
  {
    text: 'Trabalhar as ideias de similaridade e diferença em música; proporcionar a criação a partir de um elemento dado previamente; trabalhar a ideia de frases ou narrativas musicais.',
    style: ['paragraph'],
  },
  {
    text: 'Metodologia e aplicação:',
  ...
  {
    text: 'Aproximar os estudantes da ideia de composição; desenvolver uma simbologia própria que represente suas ideias musicais, fazer contato com diferentes maneiras de escrita e representação musical; atentar para as limitações existentes em qualquer tipo de escrita musical; aproximar compositores e intérpretes.',
    style: ['paragraph'],
  },
  {
    text: 'Metodologia e aplicação:',
  ...
  {
    text: 'Trabalhar a noção de solo e tutti; trabalhar a ideia de ostinato; trabalhar o conceito de forma musical.',
    style: ['paragraph'],
  },
  {
    text: 'Metodologia e aplicação:',
  ...
  {
    text: 'Iniciamos esse jogo de improvisação explicando aos estudantes o que é um ostinato. Logo após, propomos algum ostinato rítmico a ser executado por todos os estudantes com a corda solta ré, em pizzicato. Esse ostinato deve ser simples, como por exemplo, uma semínima seguida de duas colcheias.',
    style: ['paragraph'],
  },
  {
  ...
  {
    text: 'Consiste em uma variação do jogo A noite no Castelo, com um acréscimo de complexidade. Nesse caso, também criamos uma história na qual dois exploradores chegam a uma floresta encantada. Nessa floresta, cada árvore emite um som diferente. Quando os exploradores se aproximam das árvores, elas emitem o seu som. Podemos realizar esse jogo com os olhos abertos ou vendados, de forma semelhante à do jogo A noite no Castelo e as árvores podem emitir um único som ou diferentes sons conforme o contexto musical. Porém, é interessante propormos algumas diferenças entre este jogo e o jogo anterior.',
    style: ['paragraph'],
  },
  {
    text: 'Nesse jogo, uma das complexidades a serem apresentadas aos estudantes é que mais de um explorador entra na floresta ao mesmo tempo. Tal característica proporcionará a existência de um diálogo a ser “composto” pelos exploradores, que também atuarão como maestros.',
    style: ['paragraph'],
  },
  {
    text: 'Fonte: Elaborado pela autora, com base nas propostas de Claudia Freixedas.',
  ...
  {
    text: 'Trabalhar diferentes opções musicais de uma mesma sonoridade, trabalhar a ideia de narrativa musical.',
    style: ['paragraph'],
  },
  {
    text: 'Metodologia e aplicação:',
  ...
  {
    text: 'Trabalhar a liberdade e as diferentes opções para o início, o desenvolvimento e o final da “peça” musical, trabalhar questões ligadas à ecologia e à ecologia acústica; trabalhar os diálogos, as polifonias e a noção de forma musical.',
    style: ['paragraph'],
  },
  {
    text: 'Metodologia e aplicação:',
  ...
  {
    text: 'ALONSO, Chefa. Improvisación libre: la composición en movimiento. Baiona: Editorial Dos acordes S. L., 2007.',
    style: ['itemList'],
  },
  {
    text: 'DELALANDE, François. La música es un juego de niños. Buenos Aires: Ricordi Americana, 2001.',
    style: ['itemList'],
  },
  {
    text: 'COSTA, Rogério. Música errante: o jogo da improvisação livre. São Paulo: Perspectiva: Fapesp, 2016.',
    style: ['itemList'],
  },
  {
    text: 'GAINZA, Violeta. La improvisación musical. Buenos Aires: Melos de Ricordi Americana, 2009.',
    style: ['itemList'],
  },
  {
    text: 'KISHIMOTO, Tizuko Morchida. O jogo e a educação infantil. São Paulo: Cengage Learning, 2013.',
    style: ['itemList'],
  },
  {
    text: 'MATTHEWS, Wade. Improvisando: La libre creación musical. Madrid: Turner Publicaciones S. L., 2012.',
    style: ['itemList'],
  },
  {
    text: 'TOURINHO, Cristina, TOURINHO, Cristina. Ensino coletivo de instrumentos musicais: crenças, mitos, princípios e um pouco de história. In: XVI Encontro Nacional da ABEM, 2007. Mato Grosso do Sul.',
    style: ['itemList'],
  },
  {
    text: 'Fonte: Elaborado pela autora.',
  ...
  },
  {
    ...
    rest: '2018. 159 f. Dissertação (Mestrado) - Escola de Comunicações e Artes - USP, São Paulo, 2018.',
    style: ['bibliography'],
  },
]
